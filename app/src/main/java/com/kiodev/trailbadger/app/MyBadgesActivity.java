...
public class MyBadgesActivity extends ListActivity {

	public static final String TAG = MyBadgesActivity.class.getSimpleName();
    ...
    private class PeakAdapter extends ArrayAdapter<Peak> {
        ...
        public PeakAdapter(ArrayList<Peak> peaks) {
            super(MyBadgesActivity.this, 0, peaks);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = MyBadgesActivity.this.getLayoutInflater().inflate(
